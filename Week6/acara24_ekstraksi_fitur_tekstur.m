...
[tinggi, lebar] = size (I);
%---------------------------------------------------------------------
% Step 2 : Pembentukan GLCM dan Fiturnya
%---------------------------------------------------------------------
% Bentuk GLCM
GLCM0 = zeros(256, 256);
total_piksel0 =0;
...
for a=0 : 255
 for b=0 : 255
 if (GLCM0 (a+1, b+1) ~= 0)
 entropi0 = entropi0 - (GLCM0(a+1, b+1)*(log(GLCM0(a+1,b+1))));
 end
 if (GLCM45 (a+1, b+1) ~= 0)
 entropi45 = entropi45 - (GLCM45(a+1, b+1)*(log(GLCM45(a+1,b+1))));
 end
 if (GLCM90 (a+1, b+1) ~= 0)
 entropi90 = entropi90 - (GLCM90(a+1, b+1)*(log(GLCM90(a+1,b+1))));
 end
 if (GLCM135 (a+1, b+1) ~= 0)
 entropi135 = entropi135 - (GLCM135(a+1, b+1)*(log(GLCM135(a+1,b+1))));
 end
 end
end
...
fitur=[G0.asm G0.kontras G0.idm G0.entropi G0.korelasi G45.asm G45.kontras G45.idm
G45.entropi G45.korelasi G90.asm G90.kontras G90.idm G90.entropi G90.korelasi
G135.asm G135.kontras G135.idm G135.entropi G135.korelasi];
